...
The Bonferroni Correction scales alpha according to the total number of hypotheses being tested. It then only considers p-values significant if they satisfy $p_i \leq \alpha/n$, Where n is the total number of hypotheses being tested.
